          ...
          <div className="chatInterface col-md-4">
            <div className="chatList">
              <div className="chatList-header border-end">
                <img className="profile-pic rounded-circle" alt="profile-pic" src={state.currentUser.profilePic} />
                <h5 className="contactName text">{state.currentUser.displayName}</h5>
